...
void Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->nextShapeGenerated((*reinterpret_cast< std::add_pointer_t<Shape*>>(_a[1]))); break;
        case 1: _t->addedToHold((*reinterpret_cast< std::add_pointer_t<Shape*>>(_a[1]))); break;
        case 2: _t->addScore((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Scene::*)(Shape * );
            if (_t _q_method = &Scene::nextShapeGenerated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Scene::*)(Shape * );
            if (_t _q_method = &Scene::addedToHold; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Scene::addScore; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Scene::nextShapeGenerated(Shape * _t1)
{
...
// SIGNAL 1
void Scene::addedToHold(Shape * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void Scene::addScore(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
