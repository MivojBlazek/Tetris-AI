...
void Menu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setFocusToStartButton(); break;
        case 3: _t->setNextShape((*reinterpret_cast< std::add_pointer_t<Shape*>>(_a[1]))); break;
        case 4: _t->setScore((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 5: _t->setHighscore((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Menu::*)();
            if (_t _q_method = &Menu::start; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
